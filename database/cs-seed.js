...
const model = require('../database/mongo/mongoDB.js');
const fs = require('fs');
...
//////// For MongoDB run 'npm run db-seed' in the command line, then 'mongoimport --type csv -d fenty -c products --headerline --drop products.csv'