...
var createProduct = () =>{
  ...
  product["category"] = category[Math.floor(Math.random() * ratings.length)];
  ...
  product["reviews"] = reviews[[Math.floor(Math.random() * reviews.length)]]
  product["marketing"] = marketing[Math.floor(Math.random() * marketing.length)];


  product["background"] = background[Math.floor(Math.random() * background.length)];
  product["img1"] = img1[Math.floor(Math.random() * img1.length)];
  product["img2"] = img2[Math.floor(Math.random() * img2.length)];
  product["img3"] = img3[Math.floor(Math.random() * img3.length)];


  product["name1"] = name1[Math.floor(Math.random() * name1.length)];
  product["name2"] = name2[Math.floor(Math.random() * name2.length)];
  product["name3"] = name3[Math.floor(Math.random() * name3.length)];
  product["color1"] = color1[Math.floor(Math.random() * color1.length)];
  product["color2"] = color2[Math.floor(Math.random() * color2.length)];
  product["color3"] = color3[Math.floor(Math.random() * color3.length)];
...
//////NEED TO FIX THE INSERT Query to reflect schema.sql table
var seedDb = (n) => {
